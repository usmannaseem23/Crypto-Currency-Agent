...
#     """
#     Fetch the current price of the given cryptocurrency symbol from Binance API.
...
#     else:
#         return "Failed to fetch price. Please check the symbol and try again."
...
# )
# CryptoAgent = Runner.run_sync(
#     CryptoCurrency,
#     input="What is the price of BTCUSDT and ETHUSDT?",
#     run_config=config
# )
